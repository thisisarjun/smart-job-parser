...
class TestJSearchVendorInit:
    ...
    def test_init_with_api_key(self):
        ...
        vendor = JSearchVendor(api_key="test_key")
...
class TestJSearchVendorSearchJobs:
    ...
    @patch('httpx.Client')
    def test_search_jobs_success(self, mock_client_class, jsearch_vendor, sample_search_response):
...
class TestJSearchVendorGetJobDetails:
    ...
    @patch('httpx.Client')
    def test_get_job_details_success(self, mock_client_class, jsearch_vendor, sample_jsearch_job):
